...
export class StoreApi extends runtime.BaseAPI {
     ...
     */
    async getOrderByIdRaw(requestParameters: GetOrderByIdRequest): Promise<runtime.ApiResponse<IOrder>> {
        if (requestParameters.orderId === null || requestParameters.orderId === undefined) {
     ...
     */
    async placeOrderRaw(requestParameters: PlaceOrderRequest): Promise<runtime.ApiResponse<IOrder>> {
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: IOrderToJSON(requestParameters.body),
        });
