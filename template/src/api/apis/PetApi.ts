...
export class PetApi extends runtime.BaseAPI {
    ...
    async addPetRaw(requestParameters: AddPetRequest): Promise<runtime.ApiResponse<void>> {
        ...
        const response = await this.request({
            ...
            body: IPetToJSON(requestParameters.body),
        });
     ...
     */
    async findPetsByStatusRaw(requestParameters: FindPetsByStatusRequest): Promise<runtime.ApiResponse<Array<IPet>>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => jsonValue.map(IPetFromJSON));
    }
     ...
     * Finds Pets by status
     */
    async findPetsByStatus(requestParameters: FindPetsByStatusRequest): Promise<Array<IPet>> {
     ...
     * Finds Pets by tags
     */
    async findPetsByTagsRaw(requestParameters: FindPetsByTagsRequest): Promise<runtime.ApiResponse<Array<IPet>>> {
     ...
     * Finds Pets by tags
     */
    async findPetsByTags(requestParameters: FindPetsByTagsRequest): Promise<Array<IPet>> {
     ...
     * Find pet by ID
     */
    async getPetByIdRaw(requestParameters: GetPetByIdRequest): Promise<runtime.ApiResponse<IPet>> {
        if (requestParameters.petId === null || requestParameters.petId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => IPetFromJSON(jsonValue));
    }
     ...
     * Find pet by ID
     */
    async getPetById(requestParameters: GetPetByIdRequest): Promise<IPet> {
     ...
     * uploads an image
     */
    async uploadFileRaw(requestParameters: UploadFileRequest): Promise<runtime.ApiResponse<IApiResponse>> {
        if (requestParameters.petId === null || requestParameters.petId === undefined) {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => IApiResponseFromJSON(jsonValue));
    }

    /**
     * uploads an image
     */
    async uploadFile(requestParameters: UploadFileRequest): Promise<IApiResponse> {
